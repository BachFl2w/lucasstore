...
jQuery(document).ready(function ($) {
    ...
    const eventDate = new Date((new Date()).getTime() + (60*60*24*1000)*2);
    const format = `${eventDate.getFullYear()}/${eventDate.getMonth() + 1}/${eventDate.getDate()}`;

    var siteCountDown = function () {

        $('#date-countdown').countdown(format,
            function (event) {
    ...
    var OnePageNavigation = function () {
        ...
        $("body").on("click", "a[href^='#'], .site-mobile-menu .site-nav-wrap li a", function (e) {
            e.preventDefault();
